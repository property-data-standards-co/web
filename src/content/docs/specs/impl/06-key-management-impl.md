...
**Status:** Draft
**Implements:** [Sub-spec 06 — Key Management](/web/specs/06-key-management/)
...
*This document is part of the PDTF 2.0 implementation specification suite. For the protocol-level spec, see [Sub-spec 06 — Key Management](/web/specs/06-key-management/).*
