...
**Status:** Draft
**Implements:** [Sub-spec 03 — DID Methods & Identifiers](/web/specs/03-did-methods/)
...
*This document is part of the PDTF 2.0 implementation specification suite. For the protocol-level spec, see [Sub-spec 03 — DID Methods & Identifiers](/web/specs/03-did-methods/).*
