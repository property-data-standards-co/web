...
**Status:** Draft
**Implements:** [Sub-spec 14 — Credential Revocation](/web/specs/14-credential-revocation/)
...
*This document is part of the PDTF 2.0 implementation specification suite. For the protocol-level spec, see [Sub-spec 14 — Credential Revocation](/web/specs/14-credential-revocation/).*
