...
[Read the full entity graph specification →](/webv2/specs/01-entity-graph/)
...
[Read the VC data model specification →](/webv2/specs/02-vc-data-model/)
...
[Read the DID methods specification →](/webv2/specs/03-did-methods/)
...
[Read the TIR specification →](/webv2/specs/04-trusted-issuer-registry/)
...
[Read the state assembly specification →](/webv2/specs/07-state-assembly/)
...
[Read the credential revocation specification →](/webv2/specs/14-credential-revocation/)
...
| Spec | Title | Focus |
|------|-------|-------|
| [00](/webv2/specs/00-architecture-overview/) | Architecture Overview | Master reference, design decisions, trust model |
| [01](/webv2/specs/01-entity-graph/) | Entity Graph & Schema | Entity definitions, schemas, field mapping |
| [02](/webv2/specs/02-vc-data-model/) | VC Data Model | Credential format, evidence, terms of use |
| [03](/webv2/specs/03-did-methods/) | DID Methods & Identifiers | `did:key`, `did:web`, URN schemes |
| [04](/webv2/specs/04-trusted-issuer-registry/) | Trusted Issuer Registry | Registry schema, trust levels, verification |
| [06](/webv2/specs/06-key-management/) | Key Management | Key generation, storage, rotation |
| [07](/webv2/specs/07-state-assembly/) | State Assembly | Graph composition, v3 compatibility |
| [13](/webv2/specs/13-reference-implementations/) | Reference Implementations | Package architecture, CLI tools |
| [14](/webv2/specs/14-credential-revocation/) | Credential Revocation | Bitstring Status List, revocation flows |

[Browse all specifications →](/webv2/specs/00-architecture-overview/)
