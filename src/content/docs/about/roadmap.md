...
- **Developers** building adapters or integrations: [read the quickstart](/webv2/docs/quickstart/)
- **Industry stakeholders** wanting to understand the impact: [read the architecture overview](/webv2/architecture/overview/)

[Explore the architecture →](/webv2/architecture/overview/)
