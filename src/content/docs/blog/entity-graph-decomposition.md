...
The [state assembly specification](/web/specs/07-state-assembly/) provides two composition functions:
...
[Explore the entity graph in detail →](/web/architecture/entities/)
