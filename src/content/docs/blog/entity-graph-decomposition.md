...
The [state assembly specification](/webv2/specs/07-state-assembly/) provides two composition functions:
...
[Explore the entity graph in detail →](/webv2/architecture/entities/)
