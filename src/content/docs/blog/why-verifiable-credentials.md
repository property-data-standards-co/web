...
| **Migration** | Existing PDTF v1 implementations need to adopt new libraries and patterns. The [state assembly layer](/webv2/specs/07-state-assembly/) provides backward compatibility during transition. |
...
[Read the architecture overview →](/webv2/architecture/overview/)
